Jenie.component({
	name: 'swat-primary-caregiver',
	template: `
		<iframe src="https://docs.google.com/a/agapehospiceaz.com/forms/d/e/1FAIpQLSdIpR1snN6fLAcw_nYCqomlVHDnDUdADPJ5hTU6gtR3XyDaow/viewform?embedded=true" frameborder="0"></iframe>
	`
});
...
// 		<h3>Primary Caregiver Version</h3>
// 		<form>
// 			<fieldset>
...
//
// 						<li>Plans for the patients medical treatment math up with my own religious and cultural beliefs</li>
...
// 						<input type="radio" name="5-patient" value="5">Strongly Disagree
// 						<input type="radio" name="5-patient" value="4">Disagree
// 						<input type="radio" name="5-patient" value="3">Neutral
// 						<input type="radio" name="5-patient" value="2">Agree
// 						<input type="radio" name="5-patient" value="1">Strongly Agree
//
...
//
// 						<li>I am concerned about whether the patient is physically safe in my home.</li>
...
// 						<input type="radio" name="9-patient" value="1">Extremely Likely
// 						<input type="radio" name="9-patient" value="2">Likely
// 						<input type="radio" name="9-patient" value="3">Neutral
// 						<input type="radio" name="9-patient" value="4">Not Likely
// 						<input type="radio" name="9-patient" value="5">Extremely Un-Likely
// 					</ol>
// 					<fieldset>
